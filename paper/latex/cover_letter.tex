...
\address{Tommaso R. Marena\\ The Catholic University of America\\
Washington, DC, USA\\ \texttt{marena@cua.edu}\\
ORCID 0009-0002-9574-3511}
\begin{document}
...
I am submitting ``Every benchmark has a capacity: how many methods imperfect
labels can place in order'' for consideration as an Article.
