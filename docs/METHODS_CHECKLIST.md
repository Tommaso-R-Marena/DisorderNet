...
## Operator runbook
- [ ] Follow [From scratch → Path C](../README.md#from-scratch-start-here) or [`rockfish/README.md` publish path](../rockfish/README.md#publish-path-exact-usage) (`submit_publish_650m.sh` / `submit_publish_3b.sh`, then strict `publish_package/`)
- [ ] Publish go/no-go decided from rockfish README (not calendar)